...
import WebsitePortfolioTabs from "@/Components/WebsitePortfolioTabs";
...
const Page = () => {
  return (
    <>
      ...
      <main>
        <section>
          <div className="bg-[url('../../public/bg/texture-bg.png')] bg-cover pt-[140px] pb-[50px] bg-fixed">
